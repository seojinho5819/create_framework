...
@keyframes spin {
  ...
  100% { transform: rotate(360deg); }
	...
	//요청이 완료되는 시점에 프로그래스 바를 감춘다!!
	function regist() {
		//로딩바 시작
		$("#loader").addClass("loader");//동적 class 적용
		
		//form태그의 파라미터들을 전송할 수있는 상태로 둬야 data키값에 form자체를 넣을수 있다
...
<body>
		...
		<div id="loader" style="margin:auto"></div>
			<form id="member_form">
				...
				<input type="text"			name="zipcode" 		placeholder="address num..">
