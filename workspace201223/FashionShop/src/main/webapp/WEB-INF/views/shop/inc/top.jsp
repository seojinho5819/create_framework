...
<%@page import="com.koreait.fashionmall.model.domain.TopCategory"%>
<%@page import="com.koreait.fashionmall.model.domain.SubCategory"%>
<%@ page contentType="text/html;charset=UTF-8"%>
<%
                                ...
                                <nav class="navbar navbar-expand-lg align-items-start">
                                    ...
                                    <div class="collapse navbar-collapse align-items-start collapse" id="karl-navbar">
                                        <ul class="navbar-nav animated" id="nav">
                                            ...
                                            <li class="nav-item">
                                            <%if(session.getAttribute("member")==null){//세션에 담겨진 객체가 없다면 %>
                                            <a class="nav-link" href="/shop/member/loginForm">SignIn</a></li>
                                            <%}else{ %>
                                            <a class="nav-link" href="/shop/member/loginOut">SignOut</a></li>
                                            <%} %>
                                        </ul>
                                    </div>
                                </nav>
