<%@page import="com.koreait.fashionmall.model.domain.Image"%>
<%@page import="com.koreait.fashionmall.model.domain.Psize"%>
<%@page import="com.koreait.fashionmall.model.common.Formatter"%>
<%@page import="com.koreait.fashionmall.model.domain.Product"%>
                        ...
                        <!-- 썸네일 -->   
                                <ol class="carousel-indicators">
                                   ...
                                   <%if(i>=4)break; //총 4개까지만 허용할 것이므로..%>
                                    <li class="active" data-target="#product_details_slider" data-slide-to="<%=i %>" style="background-image: url(/resources/data/addon/<%=image.getImage_id()%>.<%=image.getFilename()%>);"></li>
                                    <%} %>
                                </ol>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-7">
                                        ...
                                        <!-- Add to Cart Form -->
                                        <form id="cart_form" class="cart">
                                           <input type="hidden" name="product_id" value="<%=product.getProduct_id() %>"/>
                                            <div class="quantity">
                                                <span class="qty-minus" onclick="var effect = document.getElementById('qty'); var qty = effect.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 1 ) effect.value--;return false;"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                                <input type="number" name="quantity" class="qty-text" id="qty2" step="1" min="1" max="12" name="quantity" value="1">
                                                <span class="qty-plus" onclick="var effect = document.getElementById('qty'); var qty = effect.value; if( !isNaN( qty )) effect.value++;return false;"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                            </div>
